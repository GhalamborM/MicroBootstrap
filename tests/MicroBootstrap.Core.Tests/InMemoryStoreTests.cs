...
public class InMemoryStoreTests : IClassFixture<IntegrationFixture>
{
    private readonly IntegrationFixture _integrationFixture;

    public InMemoryStoreTests(IntegrationFixture integrationFixture)
    {
    ...
    public async Task append_multiple_and_get_stream_events_with_version_should_return_correct_events()
    {
        ...
        var events = (await _integrationFixture.EventStore.GetStreamEventsAsync(
            streamId,
